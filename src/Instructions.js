      ...
      <div>
        <ul className='rules'>
          <li>
            ...
            Join existing game below or create game above.You need at least four
            players to play.
          </li>
          <li>
            <GoGistSecret className='icon'/>
            Spymasters know the secret identities of 25 agents. Their teammates know the agents only by their
            codenames.
          </li>
          <li>
            <GoPerson className='icon'/>
            Spymasters take turns giving one-word clues. A clue may relate to multiple words on the screen.
          </li>
          <li>
            <GoStar className='icon'/>
            The field
            operatives try to guess which words their spymaster meant. When a field operative chooses a word, the
            game reveals its secret identity.
          </li>
          <li>
